export default function AboutPage() {
  return (
    <section className="section-block seller-dashboard-shell">
      <article className="panel product-catalog-panel about-panel-shell">
        <div className="about-hero product-catalog-intro">
        ...
        <div className="details-grid about-details-grid">
